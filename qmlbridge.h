...
public:
  ...
  Q_PROPERTY(int mobileWidth READ getMobileWidth WRITE setMobileWidth NOTIFY
                 neverEmitted)
  Q_PROPERTY(int mobileHeight READ getMobileHeight WRITE setMobileHeight NOTIFY
                 neverEmitted)
  ...
  Q_INVOKABLE bool createFlash(QString path, int productID, int featureValues,
